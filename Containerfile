...
mkdir -p /ansible/group_vars /ansible/galaxy /ansible/group_vars/all
...
ln -s /ansible/plugins/callback/json_stats.py ./usr/local/lib/python3.10/dist-packages/ansible/plugins/callback
